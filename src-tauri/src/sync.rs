...
const ALLOWED_TABLES: &[&str] = &["clients", "interactions", "invoices", "settings", "payment_methods", "deals", "deal_flows", "suppliers", "scheduled_sends", "users", "payments", "inventory", "quotes"];
