...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_load_inbox,
            list_inbound_loads,
            approve_inbound_load,
            reject_inbound_load,
            lead_dashboard_stats,
            list_call_requests,
            confirm_call_request,
            cancel_call_request,
            reschedule_call_request,
            ...
            lot_store::get_lot_manifest_opts,
            ...
            warehouse::list_warehouse_pallets,
            warehouse::add_warehouse_pallets,
            warehouse::update_warehouse_pallet,
            warehouse::combine_warehouse_pallets,
